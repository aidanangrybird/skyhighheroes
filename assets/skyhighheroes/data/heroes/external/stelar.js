function init(hero, uuid, base, head, transformed, color) {
  ...
  initEquipment(hero, transformed, color);

  hero.addPowers("skyhighheroes:transer_system", "skyhighheroes:em_wave_change", "skyhighheroes:em_wave_being", "skyhighheroes:battle_card_predation", "skyhighheroes:battle_cards", "skyhighheroes:em_mega_buster");
  ...
  hero.addKeyBind("OMEGA_XIS_TOGGLE", "Toggle " + head + " Head", 5);
  ...
  hero.setTickHandler((entity, manager) => {
    ...
    change(entity, manager, tempProfiles(), "skyhighheroes:dyn/body_temperature", 400.0, "skyhighheroes:dyn/stelar_clothes");
  })
};
...
function initEquipment(hero, transformed, color) {

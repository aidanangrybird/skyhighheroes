...
function init(hero) {
  ...
  hero.addPrimaryEquipment("fiskheroes:chronos_rifle{display:{Name:\u00A75Tysen Tenma's Rifle},ench:[{id:34,lvl:4}]}", true, item => (item.getEnchantmentLevel(34) == 3 && item.displayName() == "\u00A75Tysen Tenma's Rifle"));

...
var blazingSingularity = implement("skyhighheroes:external/blazing_singularity");
...
function init(hero) {
  ...
  hero.setKeyBindEnabled((entity, keyBind) => {
    ...
    if (keyBind == "SHAPE_SHIFT") {
      return entity.getData("skyhighheroes:dyn/battle_card") == 0 && ((entity.getData("skyhighheroes:dyn/wave_changing_timer") == 0) ? true : entity.getData("skyhighheroes:dyn/singularity_timer") == 1);
    };

...
function init(hero) {
  ...
  hero.addPrimaryEquipment("fiskheroes:tutridium_pickaxe{display:{Name:\u00A71Liam Stelar's Pickaxe},ench:[{id:32,lvl:7},{id:35,lvl:4},{id:34,lvl:5}]}", true, item => (item.getEnchantmentLevel(32) == 7 && (item.getEnchantmentLevel(33) == 1 || item.getEnchantmentLevel(35) == 4) && item.getEnchantmentLevel(34) == 5 && item.displayName() == "\u00A71Liam Stelar's Pickaxe"));
  ...
  stelar.init(hero, "cd71352c-8cb2-448c-a69d-a310a905ce7b", "\u00A71Liam Stelar", "\u00A71Omega-Xis");

...
function init(hero) {
  ...
  stelar.initEquipment(hero, "Amethyst Galaxy", "\u00A75")

  hero.addPowers("skyhighheroes:em_wave_change", "skyhighheroes:em_wave_being", "skyhighheroes:em_battle_card_predation", "skyhighheroes:em_battle_cards", "skyhighheroes:em_battle_cards_cash", "skyhighheroes:em_galaxy_buster");
  ...
  hero.addKeyBindFunc("BATTLE_CARD_0", (player, manager) => {
    ...
    return true;
  }, "Return To Galaxy Buster", 2);
  hero.addKeyBindFunc("BATTLE_CARD_1", (player, manager) => {
    manager.setData(player, "skyhighheroes:dyn/battle_card", player.getData("skyhighheroes:dyn/selected_battle_card"));
    if (PackLoader.getSide() == "CLIENT") {
      PackLoader.printChat("\u00A7r<\u00A75Amethyst Galaxy\u00A7r> Battle Card Predation! \u00A75Barrier\u00A7r!");
    };
    return true;
  ...
  hero.addKeyBindFunc("BATTLE_CARD_2", (player, manager) => {
    manager.setData(player, "skyhighheroes:dyn/battle_card", player.getData("skyhighheroes:dyn/selected_battle_card"));
    if (PackLoader.getSide() == "CLIENT") {
      PackLoader.printChat("\u00A7r<\u00A75Amethyst Galaxy\u00A7r> Battle Card Predation! \u00A75Sword\u00A7r!");
    };
    return true;
  }, "Battle Card! Sword!", 2);
  hero.addKeyBindFunc("BATTLE_CARD_3", (player, manager) => {
    manager.setData(player, "skyhighheroes:dyn/battle_card", player.getData("skyhighheroes:dyn/selected_battle_card"));
    if (PackLoader.getSide() == "CLIENT") {
      PackLoader.printChat("\u00A7r<\u00A75Amethyst Galaxy\u00A7r> Battle Card Predation! \u00A75Shurikens\u00A7r!");
    };
    return true;
  ...
  hero.addKeyBindFunc("BATTLE_CARD_4", (player, manager) => {
    manager.setData(player, "skyhighheroes:dyn/battle_card", player.getData("skyhighheroes:dyn/selected_battle_card"));
    if (PackLoader.getSide() == "CLIENT") {
      PackLoader.printChat("\u00A7r<\u00A75Amethyst Galaxy\u00A7r> Battle Card Predation! \u00A75Gravity Pulse\u00A7r!");
    };
    return true;
  }, "Battle Card! Gravity Pulse!", 2);
  hero.addKeyBindFunc("BATTLE_CARD_5", (player, manager) => {
    manager.setData(player, "skyhighheroes:dyn/battle_card", player.getData("skyhighheroes:dyn/selected_battle_card"));
    if (PackLoader.getSide() == "CLIENT") {
      PackLoader.printChat("\u00A7r<\u00A75Amethyst Galaxy\u00A7r> Battle Card Predation! \u00A75Astroid Blast\u00A7r!");
    };
    return true;
  }, "Battle Card! Astroid Blast!", 2);
  hero.addKeyBindFunc("BATTLE_CARD_6", (player, manager) => {
    manager.setData(player, "skyhighheroes:dyn/battle_card", player.getData("skyhighheroes:dyn/selected_battle_card"));
    if (PackLoader.getSide() == "CLIENT") {
      PackLoader.printChat("\u00A7r<\u00A75Amethyst Galaxy\u00A7r> Battle Card Predation! \u00A75Star Cutter\u00A7r!");
    };
    return true;
  }, "Battle Card! Star Cutter!", 2);
  //hero.addKeyBindFunc("BATTLE_CARD_4", activateBattleCard, "Creetle", 2);
  hero.addKeyBindFunc("BATTLE_CARD_RESET_PREDATION", (player, manager) => stelar.resetBattleCard(player, manager), "Return To Galaxy Buster", 2);
  ...
  hero.addKeyBind("ENERGY_PROJECTION", "Astroid Blast", 4);
  ...
  hero.addKeyBindFunc("BATTLE_CARD_RESET", (player, manager) => stelar.resetBattleCard(player, manager), "Return To Galaxy Buster", 5);
  ...
  hero.supplyFunction("canAim", entity => stelar.canAim(entity, "amethyst"));
  ...
  hero.setTickHandler((entity, manager) => {
    if (entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1) {
      manager.setData(entity, "fiskheroes:disguise", "Amethyst Galaxy");
    };
    var x = entity.posX();
    var y = entity.posY();
    var z = entity.posZ();
    ...
    var astroid_blast = (entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && !entity.getData("skyhighheroes:dyn/predation") && entity.getData("skyhighheroes:dyn/predation_timer") < 0.35 && entity.getData("skyhighheroes:dyn/battle_card") == 5 && (entity.getData("fiskheroes:flight_boost_timer") == 0 || (entity.getData("fiskheroes:flight_boost_timer") < 0.5 && !entity.isSprinting())));
    manager.setData(entity, "skyhighheroes:dyn/astroid_blast", astroid_blast);
    manager.incrementData(entity, "skyhighheroes:dyn/astroid_blast_timer", 10, 10, entity.getData("skyhighheroes:dyn/astroid_blast"));
    ...
    if (entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getHeldItem().isEmpty() && !entity.getData("skyhighheroes:dyn/predation") && entity.getData("skyhighheroes:dyn/predation_timer") > 0.45 && entity.getData("skyhighheroes:dyn/predation_timer") < 0.55) {
      ...
      if (entity.getData("skyhighheroes:dyn/battle_card") == 2) {
        entity.playSound("skyhighheroes:wave.equip", 1, 1);
        manager.setData(entity, "skyhighheroes:dyn/amethyst", true);
        manager.setData(entity, "skyhighheroes:dyn/selected_battle_card", 0);
        manager.setData(entity, "fiskheroes:shield", true);

...
function init(hero) {
  ...
  hero.addPrimaryEquipment("fiskheroes:chronos_rifle{display:{Name:\u00A71Liam Tenma's Rifle},ench:[{id:34,lvl:5}]}", true, item => (item.getEnchantmentLevel(34) == 5 && item.displayName() == "\u00A71Liam Tenma's Rifle"));

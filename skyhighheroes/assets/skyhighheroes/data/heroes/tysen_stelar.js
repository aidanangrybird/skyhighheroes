...
function init(hero) {
  ...
  hero.addPrimaryEquipment("fiskheroes:tutridium_pickaxe{display:{Name:\u00A75Tysen Stelar's Pickaxe},ench:[{id:32,lvl:6},{id:35,lvl:4},{id:34,lvl:5}]}", true, item => (item.getEnchantmentLevel(32) == 6 && (item.getEnchantmentLevel(33) == 1 || item.getEnchantmentLevel(35) == 4) && item.getEnchantmentLevel(34) == 5 && item.displayName() == "\u00A75Tysen Stelar's Pickaxe"));
  hero.addPrimaryEquipment("fiskheroes:tutridium_shovel{display:{Name:\u00A75Tysen Stelar's Shovel},ench:[{id:32,lvl:6},{id:33,lvl:1},{id:34,lvl:5}]}", true, item => (item.getEnchantmentLevel(32) == 6 && (item.getEnchantmentLevel(33) == 1 || item.getEnchantmentLevel(35) == 4) && item.getEnchantmentLevel(34) == 5 && item.displayName() == "\u00A75Tysen Stelar's Shovel"));

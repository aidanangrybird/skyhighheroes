function init(system) {
  return {
     ...
     **/
    addGroup: function (entity, manager, groupName) {
     ...
     * @param {string} groupName - Name of group
     **/
    removeGroup: function (player, manager, groupName) {
     ...
     **/
    addGroupMember: function (player, manager, groupName, username) {
      var groups = player.getWornChestplate().nbt().getTagList("groups");
      var groupIndex = system.getGroupArray(player).indexOf(groupName);
     ...
     * @param {string} username - Username to add to group
     **/
    removeGroupMember: function (player, manager, groupName, username) {
      var groups = player.getWornChestplate().nbt().getTagList("groups");
      var groupIndex = system.getGroupArray(player).indexOf(groupName);
      var members = groups.getCompoundTag(groupIndex).getStringList("members");
      var memberIndex = system.getStringArray(members).indexOf(username);
     ...
     **/
    listGroupMembers: function (player, groupName) {
      var groups = player.getWornChestplate().nbt().getTagList("groups");
      var groupIndex = system.getGroupArray(player).indexOf(groupName);
     ...
     **/
    hasGroup: function (sender, receiver, groupName) {
      var result = false;

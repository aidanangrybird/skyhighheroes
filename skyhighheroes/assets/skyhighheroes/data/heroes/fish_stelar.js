...
function init(hero) {
  hero.setName("Fish Stelar");
  hero.setTier(10);
  hero.setChestplate("Transer");
  hero.setAliases("fish_stelar");
  hero.setVersion("Mega Man Star Force");
  hero.hide();
  hero.addPrimaryEquipment("fiskheroes:katana{Dual:1,display:{Name:\u00A75Fish Stelar's Katanas},ench:[{id:16,lvl:5},{id:19,lvl:2},{id:20,lvl:2},{id:21,lvl:3},{id:34,lvl:5}]}", true, item => item.nbt().getBoolean("Dual"));
  hero.addPrimaryEquipment("fiskheroes:ruptures_scythe{display:{Name:\u00A75Fish Stelar's Scythe},ench:[{id:16,lvl:5},{id:19,lvl:2},{id:20,lvl:2},{id:21,lvl:3},{id:34,lvl:5}]}", true);
  hero.addPrimaryEquipment("fiskheroes:chronos_rifle{display:{Name:\u00A75Fish Stelar's Rifle},ench:[{id:34,lvl:5}]}", true);
  hero.addPrimaryEquipment("fiskheroes:captain_americas_shield{Electromagnetic:1,display:{Name:\u00A75Fish Stelar's Shield},ench:[{id:16,lvl:5},{id:19,lvl:2},{id:20,lvl:2},{id:21,lvl:3},{id:34,lvl:5}]}", true, item => item.nbt().getBoolean("Electromagnetic"));
...
function isKeyBindEnabled(entity, keyBind) {
  switch (keyBind) {
    ...
    case "TELEPORT":
      return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getUUID() == uuid && entity.getData("skyhighheroes:dyn/predation_timer") < 0.75;
    case "INVISIBILITY":
      return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getUUID() == uuid && entity.getData("skyhighheroes:dyn/predation_timer") < 0.75;
    ...
    case "func_BATTLE_CARD_0":
      return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getUUID() == uuid && entity.getData("skyhighheroes:dyn/predation_timer") >= 0.75 && entity.getData("skyhighheroes:dyn/selected_battle_card") == 0;
    case "func_BATTLE_CARD_1":
      return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getUUID() == uuid && entity.getData("skyhighheroes:dyn/predation_timer") >= 0.75 && entity.getData("skyhighheroes:dyn/selected_battle_card") == 1;
    case "func_BATTLE_CARD_2":
      return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getUUID() == uuid && entity.getData("skyhighheroes:dyn/predation_timer") >= 0.75 && entity.getData("skyhighheroes:dyn/selected_battle_card") == 2;
    case "func_BATTLE_CARD_3":
      return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getUUID() == uuid && entity.getData("skyhighheroes:dyn/predation_timer") >= 0.75 && entity.getData("skyhighheroes:dyn/selected_battle_card") == 3;
    case "AIM":

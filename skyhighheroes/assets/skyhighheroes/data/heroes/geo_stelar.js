...
function getAttributeProfile(entity) {
    ...
    return (entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1.0) ? null : "INACTIVE";
}

function getDamageProfile(entity) {
    return (entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1.0) ? "MAIN" : null;
}
...
function isModifierEnabled(entity, modifier) {
    ...
    case "fiskheroes:controlled_flight":
        ...
        return (entity.getData("skyhighheroes:dyn/wave_changing_timer") > 0 && entity.getData("skyhighheroes:dyn/wave_changed"));

    case "fiskheroes:blade":

        return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getData("skyhighheroes:dyn/battle_card") == 2 && !entity.getData("fiskheroes:flight_timer") > 0 && !entity.getData("fiskheroes:flight_boost_timer") > 0;

    case "fiskheroes:shield":

        return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getData("skyhighheroes:dyn/battle_card") == 1 && !entity.getData("fiskheroes:flight_timer") > 0 && !entity.getData("fiskheroes:flight_boost_timer") > 0;

    case "fiskheroes:arrow_catching":

        return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && !entity.getData("fiskheroes:aiming") && !entity.getData("fiskheroes:shield_blocking") && !entity.getData("fiskheroes:blade");
...
function isKeyBindEnabled(entity, keyBind) {
    ...
    case "func_ELECTROMAGNETIC":
      ...
      return entity.isAlive() && !entity.getData("fiskheroes:flight_timer") > 0 && !entity.getData("fiskheroes:flight_boost_timer") > 0 && ((entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && !entity.isSneaking()) || entity.getData("skyhighheroes:dyn/wave_changing_timer") == 0);
    ...
    case "INTANGIBILITY":
        ...
        return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && (entity.getData("fiskheroes:flight_timer") > 0 || entity.getData("fiskheroes:flight_boost_timer") > 0);
    ...
    case "func_HEADTOGGLE":
        ...
        return !entity.getData("fiskheroes:flight_timer") > 0 && !entity.getData("fiskheroes:flight_boost_timer") > 0 && entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.isSneaking();

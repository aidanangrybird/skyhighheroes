...
function isModifierEnabled(entity, modifier) {
    ...
    case "fiskheroes:blade":
        ...
        return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getData("skyhighheroes:dyn/battle_card") == 2 && !entity.getData("fiskheroes:glide_flying_timer") > 0 && !entity.getData("fiskheroes:jetpacking_timer") > 0;

    case "fiskheroes:shield":

        return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && entity.getData("skyhighheroes:dyn/battle_card") == 1 && !entity.getData("fiskheroes:glide_flying_timer") > 0 && !entity.getData("fiskheroes:jetpacking_timer") > 0;
...
function isKeyBindEnabled(entity, keyBind) {
    ...
    case "INTANGIBILITY":
        ...
        return entity.getData("skyhighheroes:dyn/wave_changing_timer") == 1 && (entity.getData("fiskheroes:glide_flying_timer") > 0 || entity.getData("fiskheroes:jetpacking_timer") > 0);

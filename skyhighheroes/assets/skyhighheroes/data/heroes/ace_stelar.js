...
function init(hero) {
  ...
  hero.addPowers("skyhighheroes:em_wave_change", "skyhighheroes:em_wave_being", "skyhighheroes:em_battle_card_predation", "skyhighheroes:em_battle_cards", "skyhighheroes:em_battle_cards_ace", "skyhighheroes:em_mega_buster");
  ...
  hero.addKeyBind("OMEGA_XIS_TOGGLE", "Toggle Solar Head", 5);

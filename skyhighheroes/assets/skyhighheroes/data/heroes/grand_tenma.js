...
function init(hero) {
  ...
  hero.addPrimaryEquipment("fiskheroes:chronos_rifle{display:{Name:\u00A74Grand Tenma's Rifle},ench:[{id:34,lvl:5}]}", true, item => (item.getEnchantmentLevel(34) == 5 && item.displayName() == "\u00A74Grand Tenma's Rifle"));

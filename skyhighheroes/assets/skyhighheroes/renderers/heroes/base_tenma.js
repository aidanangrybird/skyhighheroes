...
function initEffects(renderer) {
  ...
  texture_eyes = tenma.initCustomEyes(renderer, getID());
  ...
  renderer.bindProperty("fiskheroes:opacity").setOpacity((entity, renderLayer) => {
    return 0.999999;
  }).setCondition(entity => ((entity.getUUID() == getID() && entity.isWearingFullSuit()) || entity.as("DISPLAY").getDisplayType() == "HOLOGRAM"));
};

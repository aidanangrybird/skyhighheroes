...
loadTextures({
    "base": ("skyhighheroes:dark/dark_stelar_gundam"),
    "lights": ("skyhighheroes:dark/dark_stelar_gundam_lights"),
    "suit": ("skyhighheroes:dark/dark_stelar_gundam_suit.tx.json"),
    "suit_lights": ("skyhighheroes:dark/dark_stelar_gundam_suit_lights.tx.json"),
    ...
    "cannon_bottom": ("skyhighheroes:dark/dark_stelar_gundam_bottom_cannon"),
    "cannon_left": ("skyhighheroes:dark/dark_stelar_gundam_left_cannon"),
    "cannon_right": ("skyhighheroes:dark/dark_stelar_gundam_right_cannon"),
    "cannon_top": ("skyhighheroes:dark/dark_stelar_gundam_top_cannon"),
    "cannon_front": ("skyhighheroes:dark/dark_stelar_gundam_front_cannon"),

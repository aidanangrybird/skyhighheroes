...
var body_beam_right;
var armsStart_beam;
var armRightStart_beam;
var armLeftStart_beam;
var legLeftStart_beam;
var legRightStart_beam;
var omegaXis_beam;
var omegaXis_beam_left;
var omegaXis_beam_right;
var omegaXisFP_beam;
var omegaXisFP_beam_left;
var omegaXisFP_beam_right;
var blade_beam;
...
function initHairAura(renderer, color) {
    //Hair
    hair_beams = create(renderer, "skyhighheroes:wave_glow", color, [
...
function initAura(renderer, color) {
    //Head
    head_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "head", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [0.0, 0.5, -0.0], "end": [0.0, -9.5, 0.0], "size": [10.0, 10.0] }
        ]}
    ]);
    //Body
    body_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "body", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [0.0, 0.0, 0.0], "end": [0.0, 12.0, 0.0], "size": [5.0, 8.0] }
        ]}
    ]);
    //Arms start
    armsStart_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, -3.0, 0.0], "end": [-1.0, 11.0, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Right arm
    armRightStart_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 11.0, 0.0], "end": [-1.0, -3.0, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Left arm
    armLeftStart_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "leftArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [1.0, -3.0, 0.0], "end": [1.0, 11.0, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Left Leg
    legLeftStart_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "leftLeg", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [0.0, 0.0, 0.0], "end": [0.0, 12.75, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Right Leg
    legRightStart_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "rightLeg", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [0.0, 0.0, 0.0], "end": [0.0, 12.75, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
}
function initOmegaXisAura(renderer, color) {
    //Omega-Xis Beams
    omegaXis_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
    ...
    omegaXisFP_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 3.5, 0.0], "end": [-1.0, 18.5, 0.0], "size": [9.0, 9.0] }
        ]}
    ]);
    //Blade
    blade_beam = create(renderer, "skyhighheroes:wave_glow", color, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 19.0, 0.0], "end": [-1.0, 4.0, 0.0], "size": [10.0, 7.0] }
        ]}
    ]);
}
function initDualHairAura(renderer, colorLeft, colorRight) {
    //Hair Beams
    hair_beams_left = create(renderer, "skyhighheroes:wave_glow", colorLeft, [
        { anchor: "head", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [1.5, -8.0, 2.3125], "end": [1.5, -15.5, 2.3125], "size": [4.0, 2.0] },
            { "start": [0.75, -5.5, 5.3125], "end": [0.75, -10.5, 5.3125], "size": [2.0, 1.0] }
        ]}
    ]);
    hair_beams_right = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "head", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.5, -8.0, 2.3125], "end": [-1.5, -15.5, 2.3125], "size": [4.0, 2.0] },
            { "start": [-0.75, -5.5, 5.3125], "end": [-0.75, -10.5, 5.3125], "size": [2.0, 1.0] }
        ]}
...
function initDualAura(renderer, colorLeft, colorRight) {
    //Head
    head_beam_right = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "head", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-2.0, 0.5, 0.0], "end": [-2.0, -9.5, 0.0], "size": [10.0, 4.6875] }
        ]}
    ]);
    head_beam_left = create(renderer, "skyhighheroes:wave_glow", colorLeft, [
        { anchor: "head", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [2.0, 0.5, 0.0], "end": [2.0, -9.5, 0.0], "size": [10.0, 4.6875] }
        ]}
    ]);
    //Body
    body_beam_left = create(renderer, "skyhighheroes:wave_glow", colorLeft, [
        { anchor: "body", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [2.0, 0.0, 0.0], "end": [2.0, 12.0, 0.0], "size": [4.6875, 4.6875] }
        ]}
    ]);
    body_beam_right = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "body", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-2.0, 0.0, 0.0], "end": [-2.0, 12.0, 0.0], "size": [4.6875, 4.6875] }
        ]}
    ]);
    //Arms start
    armsStart_beam = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, -3.0, 0.0], "end": [-1.0, 11.0, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Right arm
    armRightStart_beam = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 11.0, 0.0], "end": [-1.0, -3.0, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Left arm
    armLeftStart_beam = create(renderer, "skyhighheroes:wave_glow", colorLeft, [
        { anchor: "leftArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [1.0, -3.0, 0.0], "end": [1.0, 11.0, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Left Leg
    legLeftStart_beam = create(renderer, "skyhighheroes:wave_glow", colorLeft, [
        { anchor: "leftLeg", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [0.0, 0.0, 0.0], "end": [0.0, 12.75, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
    //Right Leg
    legRightStart_beam = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "rightLeg", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [0.0, 0.0, 0.0], "end": [0.0, 12.75, 0.0], "size": [4.75, 4.75] }
        ]}
    ]);
}
function initDualOmegaXisAura(renderer, colorLeft, colorRight) {
    //Omega-Xis Beams
    omegaXis_beam_right = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
    ...
    omegaXis_beam_left = create(renderer, "skyhighheroes:wave_glow", colorLeft, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 3.5, -2.0], "end": [-1.0, 12.5, -2.0], "size": [3.0, 6.0] },
            { "start": [-6.0, 3.7, -3.0], "end": [-5.5, 7.7, -3.0], "size": [1.0, 1.0] },
            { "start": [-5.0, 3.6, -3.0], "end": [-4.5, 10.6, -3.0], "size": [1.0, 1.0] },
    ...
    //Omega-Xis First Person
    omegaXisFP_beam_left = create(renderer, "skyhighheroes:wave_glow", colorLeft, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 3.5, -2.0], "end": [-1.0, 18.5, -2.0], "size": [3.0, 9.0] }
        ]}
    ]);
    omegaXisFP_beam_right = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 3.5, 2.0], "end": [-1.0, 18.5, 2.0], "size": [3.0, 9.0] }
        ]}
    ]);
    //Blade
    blade_beam = create(renderer, "skyhighheroes:wave_glow", colorRight, [
        { anchor: "rightArm", renderLayer: "CHESTPLATE", mirror: false, entries: [
            { "start": [-1.0, 19.0, 0.0], "end": [-1.0, 4.0, 0.0], "size": [10.0, 7.0] }
        ]}
    ]);
...
function renderHairAura(entity, renderLayer) {
...
function renderAura(entity, renderLayer) {
    if (renderLayer == "CHESTPLATE") {
...
function renderOmegaXisAura(entity, renderLayer, isFirstPersonArm) {
    if (renderLayer == "CHESTPLATE") {
...
function renderDualHairAura(entity, renderLayer) {
    if (renderLayer == "CHESTPLATE") {
...
function renderDualAura(entity, renderLayer) {
    if (renderLayer == "CHESTPLATE") {
...
function renderDualOmegaXisAura(entity, renderLayer, isFirstPersonArm) {
        if (renderLayer == "CHESTPLATE") {
        blade_beam.progress = (entity.getData('skyhighheroes:dyn/battle_card') == 2 ? 1.0 : 0.0);
        blade_beam.render(renderLayer);
        if (!isFirstPersonArm) {

...
loadTextures({
  ...
  "omega_xis_right": "skyhighheroes:razor/razor_stelar_omega_xis_right.tx.json",
  "omega_xis_right_lights": "skyhighheroes:razor/razor_stelar_omega_xis_right_lights.tx.json",
  "omega_xis_right_wave_change_lights": "skyhighheroes:razor/razor_stelar_omega_xis_right_wave_change_lights.tx.json",
  "omega_xis_left": "skyhighheroes:razor/razor_stelar_omega_xis_left.tx.json",
  "omega_xis_left_lights": "skyhighheroes:razor/razor_stelar_omega_xis_left_lights.tx.json",
  "omega_xis_left_wave_change_lights": "skyhighheroes:razor/razor_stelar_omega_xis_left_wave_change_lights.tx.json",
  "omega_xis_top": "skyhighheroes:razor/razor_stelar_omega_xis_top.tx.json",
  "omega_xis_top_lights": "skyhighheroes:razor/razor_stelar_omega_xis_top_lights.tx.json",
  "omega_xis_bottom": "skyhighheroes:razor/razor_stelar_omega_xis_bottom.tx.json",
  "omega_xis_bottom_lights": "skyhighheroes:razor/razor_stelar_omega_xis_bottom_lights.tx.json",
  "omega_xis_bottom_top_wave_change_lights": "skyhighheroes:razor/razor_stelar_omega_xis_bottom_top_wave_change_lights.tx.json",
  "omega_xis_front": "skyhighheroes:razor/razor_stelar_omega_xis_front.tx.json",
  "omega_xis_front_wave_change_lights": "skyhighheroes:razor/razor_stelar_omega_xis_front_wave_change_lights.tx.json",

function init(renderer, namePerson, satellite, uuid) {
    ...
    renderer.setItemIcons((satellite + "_transer"));
    renderer.showModel("CHESTPLATE", "body", "rightArm", "leftArm", "rightLeg", "leftLeg", "head", "headwear");
...
var utils = implement("skyhighheroes:external/utils");

function initEffects(renderer) {
    //Teleportation Opacity
    teleport = renderer.bindProperty("fiskheroes:opacity").setOpacity((renderer, 0, 1, "fiskheroes:teleport_timer"));
    teleport.includeEffects([blade, ears, omegaXisBottom, omegaXisFront, omegaXisLeft, omegaXisRight, omegaXisTop, hair]);
    //Ears
    ...
    omegaXisLeft.setRotation(0.0, 0.0, 0.0).setCurve(0.0, 0.0).setOffset(0.0, 0.0, 0.0);
